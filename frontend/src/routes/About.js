        ...
        <div className="flex flex-col items-center">
            ...
            <div className="max-w-4xl m-8">
                <div className="text-xl mb-4">
                    Application réalisé avec ❤️ par
                </div>
                ...
                <div className="flex flex-col gap-4">
                    <Hero
                        name="Sasha Dhaeyer"
                        linkedin=""
                        pic={process.env.PUBLIC_URL + "/assets/sasha.png"}
                    />
                ...
                <div className="mt-4">
                    Étudiants en informatique de gestion à la HELHa Campus Mons,
                    dans le cadre du cours d'Applications entreprise multi-tiers
                    de Mr. V. Altares.
                </div>
